...
class PHP_CRUD_API {
	...
	protected function mapMethodToAction($method,$key) {
		return "key en map method action".$key;
		echo "method en map method action".$method;
		#ver como distingo el sale
		switch ($method) {
	...
	public function executeCommand() {
		...
		if (!$this->settings['request']) {
			...
			switch($parameters['action']){
				...
				case 'sale': $this->makeSale($parameters); break;
			}
		}
	}
}
